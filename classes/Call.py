...
class Call:
    ...
    def __init__(self, query):
        ...
        print(query[4].replace("+05:30", ""))
        self.time = datetime.strptime(query[4].replace("+05:30", ""), "%Y-%m-%d %H:%M:%S").replace(tzinfo=ZoneInfo("Asia/Kolkata")) + timedelta(hours=5, minutes=30) 
